...
"@
    ...
    if ($html -notmatch 'js/game-share\.js') {
        $html = $html.Replace('</body>', '    <script src="../js/analytics.js?v=1"></script>' + "`r`n    " + '<script src="../js/game-share.js?v=2"></script>' + "`r`n    " + '<script src="../js/mobile-controls.js?v=1"></script>' + "`r`n</body>")
    }
